...
export const siteMetadata: Metadata = {
  ...
  description: "Firma Wielmi oferuje instalacje elektryczne, inteligentne domy i sieci lokalne w Krakowie. Profesjonalne rozwiązania dla nowoczesnych domów.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Profesjonalne instalacje elektryczne i inteligentne systemy domowe dla nowoczesnych domów w Krakowie.",
    url: "https://wielmi.pl",
    siteName: "Wielmi",
    locale: "pl_PL",
    type: "website",
