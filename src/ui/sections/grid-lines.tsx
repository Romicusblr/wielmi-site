...
const GridLines: FC = function () {
  return (
    <>
      <GridLineV className="hidden sm:block start-[12vw] z-20" />
      <GridLineV className="hidden lg:block start-[50vw] z-0"/>
      <GridLineV className="hidden sm:block end-[12vw] z-20" />
    </>
  );
};
