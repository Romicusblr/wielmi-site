...
const Hero: FC = function () {
  return (
    <div className="relative w-full h-screen grid-layout grid-rows-6 text-dark-grey">
      ...
      <div className="flex justify-center gap-4 sm:col-start-2 h-12 row-start-5">
      ...
      <div className="flex h-12 justify-center lg:row-start-5 lg:col-start-3 sm:col-start-2 row-start-6">
